      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display:'flex', alignItems:'center', justifyContent:'flex-end', gap:'0.4rem' }}>
            ...
            {/* Instagram */}
            {links.instagram ? (
              <a href={links.instagram} target="_blank" rel="noreferrer" style={iconBtn} title="Instagram"><IgIcon /></a>
            ) : (
              <span style={iconBtn} title="Instagram"><IgIcon /></span>
            )}
            {/* Line */}
            {links.line ? (
              <a href={links.line} target="_blank" rel="noreferrer" style={iconBtn} title="Line"><LineIcon /></a>
            ) : (
              <span style={iconBtn} title="Line"><LineIcon /></span>
            )}
            {/* Gmail */}
            <a href={`mailto:${siteData.email}`} style={iconBtn} title="Gmail"><GmailIcon /></a>
      ...
      {isMobile && (
        <>
          ...
          <div style={{
            ...
            width:'260px', background:'var(--bg)', borderLeft:'1px solid var(--border)',
            transform: open ? 'translateX(0)' : 'translateX(100%)',
            transition:'transform 0.3s cubic-bezier(0.4,0,0.2,1)',
            display:'flex', flexDirection:'column',
            paddingTop:'80px', paddingBottom:'2rem', paddingLeft:'2rem', paddingRight:'2rem',
          }}>
