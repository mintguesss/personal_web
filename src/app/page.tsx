  ...
  return (
    <div style={{ minHeight:'100vh' }}>
      <section style={{ minHeight:'100vh', display:'flex', flexDirection:'column' }}>
        ...
        <div style={{ flex:1, display:'grid', gridTemplateColumns:'50% 50%', alignItems:'center' }}>

          {/* Left — photo */}
          <div style={{ padding:'5rem 2rem 0 2.5rem', borderRight:'1px solid var(--border)', display:'flex', alignItems:'center', justifyContent:'center', height:'100%' }}>
          ...
          {/* Right */}
          <div style={{ display:'flex', flexDirection:'column', justifyContent:'center', padding:'4rem 4rem 4rem 5rem' }}>
