  ...
  return (
    <div style={{ paddingTop:'64px', minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:'1100px', margin:'0 auto', padding:'clamp(3rem,6vw,6rem) clamp(2rem,5vw,5rem)' }}>
        {years.map(year => (
          <div key={year} style={{ display:'grid', gridTemplateColumns:'80px 1fr', gap:'2.5rem', marginBottom:'3.5rem' }}>
            {/* Year label */}
            ...
            <div>
              {byYear[year].map((a, i) => (
                <div key={i} style={{ display:'grid', gridTemplateColumns:'1fr auto', gap:'2rem', alignItems:'center', padding:'1.1rem 0', borderBottom:'1px solid var(--border)' }}>
